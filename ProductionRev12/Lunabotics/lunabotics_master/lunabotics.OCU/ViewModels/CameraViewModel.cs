...
{
    public abstract class CameraViewModel : Base.BaseINotifyPropertyChanged
    {
        ...
        {
           // System.Diagnostics.Debug.WriteLine(this.Name + " received image");
            CameraFeed = e.Image;
        }
        ...
        public short GetEncodedState()
        {
            int frameRate = (this.IsActive && this.IsEnabled ? this.FrameRate : 0);
            return Comms.States.VideoState.EncodeVideoState(this.Quality, frameRate);
        }
        ...
        private void DoToggle()
        {
            ...
            {
                Console.WriteLine("CameraViewModel: " + ex.Message);
            }
        }
    }
}
